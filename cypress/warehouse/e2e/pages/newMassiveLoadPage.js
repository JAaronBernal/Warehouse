class BulkLoad {
    elements = {
        ...
        //In Proccess doc
        processDoc: () => cy.get('.css-1ksjws7 > .MuiButton-contained'),
        processDocSandbox: () => cy.get('.css-1fiu3v1 > .MuiButton-contained'),
        processDocXpath: () => cy.xpath('//*[@id="56f9c060-e4cd-4ca7-bc29-cf5af8c77746"]/div[4]/button[2]'),
        //Cancel doc
    ...
    proccesDoc() {
        cy.wait(2500)
        this.elements.processDocSandbox().click();
        //this.elements.processDoc().click();
    }
