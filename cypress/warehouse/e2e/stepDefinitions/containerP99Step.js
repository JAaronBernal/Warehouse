...
Then("the user works in containersP99 with {string} {string} {string}", (layout, numContainer, fingerID) => {
    warehouse.actLayout(layout);
    warehouse.createAddTransferContainerP99(numContainer,fingerID);
